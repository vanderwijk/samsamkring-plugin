...
function samsam_enqueues() {
	...
	wp_enqueue_style( 'calculate', '/wp-content/plugins/samsamkring-plugin/calculate.css', array(), '2.0.1', 'all');
	...
	wp_enqueue_script( 'calculate', '/wp-content/plugins/samsamkring-plugin/calculate.js', array( 'jquery' ), '2.0.1', true );
