...
function samsam_register_settings() {
	...
	register_setting( 'samsam-settings-group', 'monthly_deposit_label', array('type' => 'string', 'sanitize_callback' => 'samsam_sanitisation', 'default' => 'in de afgelopen 12 maanden (gemiddeld).') );
